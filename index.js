...
*/
const A187 = '👾VARGAS250👾'; // JANGAN UBAH-UBAH INFO!!!
...
conn.sendMessage(id, ' *Owner VARGAS250 Wa.me/+6281227560249* ' ,MessageType.text);
}
else if (text == '#help'){
...
conn.sendMessage(id, ' *Creator VARGAS250 Wa.me/+6281227560249* ' ,MessageType.text);
}
else if (text == 'Pagi'){
